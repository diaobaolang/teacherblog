<template>
  <div class="honor-wall">
    <h1 class="page-title">荣誉墙</h1>
    <p class="page-sub">记录每一个值得纪念的瞬间</p>

    <div v-if="loading" class="loading">
      <el-skeleton :rows="6" animated />
    </div>

    <el-empty v-else-if="groups.length === 0" description="暂无荣誉照片" />
...
import { getAllHonorData } from '../api'

const groups = ref([])
const loading = ref(true)

// 查看器状态 - 改为展示当前选中的整个分组的照片
